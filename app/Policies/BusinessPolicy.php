...
{
    public static function permittedModify(User $user, Business $business): bool
    {
    ...
    {
        return BusinessPolicy::permittedModify($user, $business);
    }
    ...
    {
       return $user->hasRole('admin'); return false;
    }
