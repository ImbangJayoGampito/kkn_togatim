...
<?php $component = Mary\View\Components\Header::resolve(['title' => 'Roles Management','separator' => true,'progressIndicator' => true] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Mary\View\Components\Button::resolve(['label' => 'Create Role'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Mary\View\Components\Table::resolve(['headers' => $headers,'rows' => $roles,'sortBy' => $sortBy,'striped' => true,'withPagination' => true,'perPage' => 'perPage','perPageValues' => [5, 10, 15, 25, 50]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
            <?php $__bladeCompiler = $__bladeCompiler ?? null; $loop = null; $__env->slot('cell_permissions', function($role) use ($__env,$__bladeCompiler) { $loop = (object) $__env->getLoopStack()[0] ?>
...
<?php $component = Mary\View\Components\Badge::resolve(['value' => $permission->name] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
            ...
            <?php $__bladeCompiler = $__bladeCompiler ?? null; $loop = null; $__env->slot('actions', function($role) use ($__env,$__bladeCompiler) { $loop = (object) $__env->getLoopStack()[0] ?>
...
<?php $attributes = $attributes->except(\Mary\View\Components\Button::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'btn-ghost btn-sm','@click' => '$wire.edit('.e($role->id).')']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal602b228a887fab12f0012a3179e5b533)): ?>
<?php $attributes = $__attributesOriginal602b228a887fab12f0012a3179e5b533; ?>
...
<?php $attributes = $attributes->except(\Mary\View\Components\Button::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'btn-ghost btn-sm text-error','@click' => '$wire.delete('.e($role->id).')','wire:confirm.prompt' => 'Are you sure?\nType DELETE to confirm|DELETE']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal602b228a887fab12f0012a3179e5b533)): ?>
<?php $attributes = $__attributesOriginal602b228a887fab12f0012a3179e5b533; ?>
...
<?php $component = Mary\View\Components\Drawer::resolve(['title' => ''.e($editing_id ? 'Edit Role' : 'Create Role').'','right' => true,'separator' => true,'withCloseButton' => true] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Mary\View\Components\Choices::resolve(['label' => 'Permissions','options' => $permissions,'optionValue' => 'id','optionLabel' => 'name','searchable' => true,'hint' => 'Select permissions for this role'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'selected_permissions','multiple' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
</div><?php /**PATH D:\WebDev\kkn_togatim\resources\views\livewire\admin\roles\index.blade.php ENDPATH**/ ?>