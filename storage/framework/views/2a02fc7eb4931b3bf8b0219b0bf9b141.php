...
<?php $component = Mary\View\Components\Card::resolve(['title' => 'Forgot Password','subtitle' => 'No problem. Just let us know your email address and we will email you a password reset link.'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['type' => 'success','message' => ''.e(session('status')).'','class' => 'mb-4']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php $component->withAttributes(['wire:submit' => 'sendResetLink']); ?>
...
<?php $component = Mary\View\Components\Button::resolve(['label' => 'Back to login','link' => ''.e(route('login')).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                <?php if (isset($component)) { $__componentOriginal602b228a887fab12f0012a3179e5b533 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal602b228a887fab12f0012a3179e5b533 = $attributes; } ?>
<?php $component = Mary\View\Components\Button::resolve(['label' => 'Reset Password','icon' => 'o-paper-airplane','spinner' => 'sendResetLink'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php endif; ?>
</div><?php /**PATH D:\WebDev\kkn_togatim\resources\views\livewire\auth\forgot-password.blade.php ENDPATH**/ ?>