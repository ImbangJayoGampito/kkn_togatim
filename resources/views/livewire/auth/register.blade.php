...
<div class="md:w-96 mx-auto mt-20">
    ...
    <x-card title="Daftar" subtitle="Create a new account to get started">
        <x-form wire:submit="register">
            ...
            <x-input placeholder="Konfirmasi Kata Sandi" wire:model="password_confirmation" type="password"
                icon="o-key" />

            <x-slot:actions>
                <x-button label="Sudah Mendaftar?" class="btn-ghost" link="/login" />
                <x-button label="Daftar" type="submit" icon="o-paper-airplane" class="btn-primary"
                    spinner="register" />
            </x-slot:actions>
        </x-form>
    </x-card>
